...
@property (strong, nonatomic) AVCaptureStillImageOutput *imageOutput;//输出图片
@property (strong, nonatomic) AVCaptureMovieFileOutput *movieOutput;//输出小视频
...
/*
    AVCaptureDevice 定义了很多方法，让开发者控制ios设备上的摄像头。可以独立调整和锁定摄像头的焦距、曝光、白平衡。对焦和曝光可以基于特定的兴趣点进行设置，使其在应用中实现点击对焦、点击曝光的功能。
